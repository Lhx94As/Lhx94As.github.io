...
- <span style="display:inline-block; background-color:#00369F; color:#fff; padding:0px 7px; margin-right:5px; font-size:13px;">IEEE TASLP 2025</span> [Mamba in Speech: Towards an Alternative to Self-Attention](https://ieeexplore.ieee.org/document/10985910), Xiangyu Zhang\*, Qiquan Zhang\*, **<u>Hexin Liu</u><sup>†</sup>***, Tianyi Xiao, Xinyuan Qian, Beena Ahmed, Eliathamby Ambikairajah, Haizhou Li, Julien Epps.

- <span style="display:inline-block; background-color:#00369F; color:#fff; padding:0px 7px; margin-right:5px; font-size:13px;">IEEE TASLP 2025</span> [Aligning Speech to Languages to Enhance Code-switching Speech Recognition](https://ieeexplore.ieee.org/document/11231368), **<u>Hexin Liu</u>**, Xiangyu Zhang, Haoyang Zhang, Leibny Paola Garcia, Andy W.H. Khong, Eng Siong Chng, Shinji Watanabe.
...
- <span style="display:inline-block; background-color:#00369F; color:#fff; padding:0px 7px; margin-right:5px; font-size:13px;">Interspeech 2026</span> [Improving Code-Switching ASR with Code-Mixing Guided Synthetic Speech](https://arxiv.org/abs/2606.19381), Yue Heng Yeo, Haoyang Li, Yizhou Peng, Shreyas Gopal, **<u>Hexin Liu</u><sup>†</sup>**, Leibny Paola Garcia, Hardik B. Sailor, Jeremy H. M. Wong, Eng Siong Chng.  
...
- **Area/Session Chair:**&nbsp; Interspeech (2023), APSIPA-TPC (2025-27), IALP (2024), CCL (2026).   
...
- *Interspeech 2026* Tutorial: Advances in Data-Efficient Multilingual and Crosslingual Speech Recognition Powered by LLMs
